    ...
    $.extend(Datetimepicker.prototype, {
        ...
        parseDate: function (format, value, settings) {
          ...
          var getAMPM = function(match) {
            result = (value.charAt(iValue) == 'p' || value.charAt(iValue) == 'P') ;
            iValue++ ;
            if (iFormat + 1 < format.length && format.charAt(iFormat + 1) == fmt) {
              iFormat++;
              iValue++;
              }
            return result ;
          ...
          if (pm) hours += 12;
          var date = this._daylightSavingAdjust(new Date(year, month - 1, day, hours, minutes, seconds));
